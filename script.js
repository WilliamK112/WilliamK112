...
(function setupLanguageToggle() {
  ...
  const translations = {
    ...
    zh: {
      ...
      githubContribTitle: 'GitHub 贡献图',
      githubContribNote: '展示我的公开 GitHub 活跃度，包括品牌化 3D 贡献图，以及根据个人主页贡献记录自动生成的 contribution snake。',
      githubContribProfile: '查看主页',
      githubContribBanner: '品牌化 3D 贡献图',
      githubContribSnake: '根据 GitHub 活跃度生成的 contribution snake',
      githubContribStat1: '公开贡献记录',
      githubContribStat2: 'GitHub Actions 自动刷新',
      githubContribStat3: '开源交付信号',
      projectsTitle: '项目',
      projectTechLabel: '技术：',
